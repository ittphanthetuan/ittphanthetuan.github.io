export default {
  ...
  tableInfo: {
    ...
    body: [
      {
        cells: ['<b>A</b>', '<b>Programing/Languages</b>', '', '', '', '', ''],
      },
      {
        cells: ['1', 'CSS/CSS3', '', '', '<b>x</b>', '', '2'],
      },
      {
        cells: ['2', 'Jade', '', '', '<b>x</b>', '', '1'],
      },
      {
        cells: ['3', 'HTML', '', '', '<b>x</b>', '', '2'],
      },
      {
        cells: ['4', 'Bootstrap', '', '', '<b>x</b>', '', '2'],
      },
      {
        cells: ['5', 'Javascript', '', '', '<b>x</b>', '', '2'],
      },
      {
